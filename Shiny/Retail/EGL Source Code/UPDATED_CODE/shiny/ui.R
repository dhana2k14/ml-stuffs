  ...
  column(3,
         ...
         wellPanel(
           ...
           fluidRow(column(6,
            ...
            dateInput("startDateServ",label="Start Date",min="2015-01-01",max = "2015-01-31", format = "yyyy-mm-dd",value = "2015-01-01")
                           
           ),
           column(6,
                  #uiOutput("endDateUI")
                  dateInput("endDateServ",label="End Date",min="2015-01-01",max = "2015-01-31", format = "yyyy-mm-dd",value = "2015-01-31")
           )
           ),
           ...
           selectizeInput(
             "itemCategoryServ", label="Item Category ", choices = c("Christmas Cards","Christmas Gift Wrap","Occasions Cards","Occasions Wrap","Calendars & Diaries","Crackers","Christmas Decorations","Luggage & Travel","Toys","Computer Games"), multiple = TRUE ,selected = "Christmas Cards"
           ),
