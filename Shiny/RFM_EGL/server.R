...
shinyServer(function(input, output,session) {
  ...
  output$startDateUI<-renderUI({
    ...
    dateInput("startDateServ",label="Start Date",min=min(date_calender()),max = max(date_calender()),format = "yyyy-mm-dd", value = min(date_calender()) )
  ...
  output$endDateUI<-renderUI({
    dateInput("endDateServ",label="End Date",min=min(date_calender()),max = max(date_calender()),format = "yyyy-mm-dd", value = max(date_calender()) )
