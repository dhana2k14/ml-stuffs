...
run;
	...
	proc sort data = Comp1Repo&n&&Suburb&i;
	by Variables;
	run;

	data WGComp1Repo&n&&Suburb&i;
	set Comp1Repo&n&&Suburb&i;
	...
	%end; 
		...
		%do n=2 %to &Obs_1;
		proc append base=Comp1Repo1&&Suburb&i data=Comp1Repo&n&&Suburb&i force;
		run;
		proc append base=WGComp1Repo1&&Suburb&i data=WGComp1Repo&n&&Suburb&i force;
		run;
		proc append base=DWComp1Repo1&&Suburb&i data=DWComp1Repo&n&&Suburb&i force;
		run;
		%end;

/*			proc datasets;*/
/*			copy in=work out=coj move;*/
/*			select Comp1Repo1&&Suburb&i;*/
/*			quit;*/
/**/
/*			proc datasets;*/
/*			copy in=work out=coj move;*/
/*			select WGComp1Repo1&&Suburb&i;*/
/*			quit;*/
/**/
/*			proc datasets;*/
/*			copy in=work out=coj move;*/
/*			select DWComp1Repo1&&Suburb&i;*/
/*			quit;*/
