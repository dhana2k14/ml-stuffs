...
select a.InvNbhd,a.InvQual,a.InvCond,a.InvTla,a.InvGba,a.InvGar,a.InvExt,a.InvPin,
a.InvTotEmv,a.InvX,a.InvY,b.SaleNbhd,b.SaleQual,b.SaleCond,b.SaleTla,b.SaleGba,b.SaleGar,b.SaleExt,
...
proc sql noprint;
create table &libname..PinLeComp as select InvPin from &libname..&NewData_1 group by InvPin having count(InvPin)<5;
quit;
run;

data _null_;
set &libname..PinLeComp end=lastrec;
if lastrec then do;
call symput ('C',_n_);
end;
run;
